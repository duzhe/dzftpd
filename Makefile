dzftp: ftpd.o ftp_server.o ftp_client_ctrlfile.o ftp_config.o request.o main.o ftp_client_datafile.o global.o ftp_dir.o
	g++ -g -Wall -o dzftp ftp_client_ctrlfile.o ftp_config.o request.o main.o ftpd.o ftp_server.o ftp_client_datafile.o global.o ftp_dir.o
